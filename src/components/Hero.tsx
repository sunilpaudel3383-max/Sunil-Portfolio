            ...
            <div>
              ...
              <FadeIn delay={800} duration={1000}>
                <p className="mb-5 max-w-xl text-base text-gray-300 md:text-lg">
                  Registered Civil Engineer specializing in structural analysis,
                  bridge design, and resilient infrastructure.
                </p>
              </FadeIn>
